...
Route::controller(Hongon\Hongon\Controllers\LineController::class)->group(function () {
    Route::get('api/hongon/line--stats', 'getLineStats');
});

Route::controller(Hongon\Hongon\Controllers\DummyController::class)
->middleware('\Tymon\JWTAuth\Middleware\GetUserFromToken')->group(function () {
    Route::post('api/hongon', 'dummy');
});
